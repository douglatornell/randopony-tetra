${rider.full_name | n} <${rider.email}> has pre-registered for the ${brevet} brevet.  Zher name should appear along with the other pre-registered riders on the list at <${brevet_page_url}>, and in the rider's email address list at <${rider_emails}>.
