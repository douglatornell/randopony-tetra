${rider.full_name | n} <${rider.email}> has pre-registered for the ${populaire.short_name}.  Zher name should appear along with the other pre-registered riders on the list at <${pop_page_url}> and in the spreadsheet at <${ rider_list_url}>.
